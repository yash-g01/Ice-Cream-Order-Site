...
<html>
  ...
  <body>
    ...
    <?php
    include 'config.php';
    $Prod = mysqli_query($con, "select * from Products where Stock>0");
    ...
    <h1>Sorry, you cannot order right now. :( </h1><br>
    <h6>We are re-stocking. Please check back in a while.</h6>
    ";
  }
  ?>
  </div>
